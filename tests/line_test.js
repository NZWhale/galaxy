...
function isClose(a, b) {
    ...
    return a - b < floatComparisonThreshold;
}
...
function testCreateAllLinesBetweenStars() {
    ...
    assert(
        expectedLinesListLength === actualLinesListLength,
        `Error in distance calculation, expected ${expectedLinesListLength}, received ${linesList.length}`
    );

    assert(
        linesList[0] instanceof Line,
